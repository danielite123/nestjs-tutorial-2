-- CreateTable
CREATE TABLE "GropuPost" (
    "id" SERIAL NOT NULL,
    "title" TEXT NOT NULL,
    "description" TEXT NOT NULL,

    CONSTRAINT "GropuPost_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "UserOnGroupPosts" ADD CONSTRAINT "UserOnGroupPosts_groupPostId_fkey" FOREIGN KEY ("groupPostId") REFERENCES "GropuPost"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
